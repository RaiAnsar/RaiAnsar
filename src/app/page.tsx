      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Full-stack developer, DevOps expert, and problem solver.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I&apos;m Rai, a full-stack developer and DevOps expert based in
            Islamabad. I build fast websites, fix broken servers, and turn
            technical debt into clean, scalable systems. 6+ years of shipping
            code that works.
          </p>
