        ...
        >
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <motion.a
                href="#contact"
                className="group relative inline-flex items-center gap-3 px-8 py-4 text-sm md:text-base text-[#0a0a0a] font-bold rounded-full overflow-hidden"
              ...
              >
                ...
                />
                <span className="relative z-10" style={{ color: '#0a0a0a' }}>Start a Conversation</span>
                <svg
