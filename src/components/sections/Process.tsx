...
export function Process() {
  ...
  // Main scroll progress for timeline
  const { scrollYProgress } = useScroll({
    target: containerRef,
    offset: ['start 0.2', 'end 0.8'],
  });

  // Scroll to top when section comes into view (only once)
  useEffect(() => {
    if (isInView && !hasScrolledToTop && containerRef.current) {
  ...
  // Transform progress to percentage for line fill
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background: 'radial-gradient(circle, rgba(0, 255, 240, 0.06) 0%, transparent 60%)',
            right: '10%',
            top: '50%',
          }}
      ...
      <div className="container relative z-10">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-1 md:w-1.5 hidden md:block" aria-hidden="true">
            ...
            {/* Traveling pulse at end of line */}
            <motion.div
